(function bootstrapSimplifyConfig(global) {
  ...
  var defaults = {
    ...
    monetization: {
      ...
      adminAssignPlanPath: "/api/admin/plan/assign",
      adminRecoveryRunPath: "/api/admin/recovery/checkout/run",
      adminRecoveryStatsPath: "/api/admin/recovery/checkout/stats",
      adminMarketingSpendPath: "/api/admin/marketing/spend",
      oneCredits: 1,
      packCredits: 10,
